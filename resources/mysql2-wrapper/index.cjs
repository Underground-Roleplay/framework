...
const Long = __webpack_require__(52);
...
const AuthSwitchRequest = __webpack_require__(72);
const AuthSwitchRequestMoreData = __webpack_require__(73);
const AuthSwitchResponse = __webpack_require__(74);
const BinaryRow = __webpack_require__(75);
const BinlogDump = __webpack_require__(76);
const ChangeUser = __webpack_require__(77);
const CloseStatement = __webpack_require__(78);
const ColumnDefinition = __webpack_require__(79);
const Execute = __webpack_require__(80);
const Handshake = __webpack_require__(82);
const HandshakeResponse = __webpack_require__(83);
const PrepareStatement = __webpack_require__(84);
const PreparedStatementHeader = __webpack_require__(85);
const Query = __webpack_require__(86);
const RegisterSlave = __webpack_require__(87);
const ResultSetHeader = __webpack_require__(88);
const SSLRequest = __webpack_require__(91);
const TextRow = __webpack_require__(92);
...
const Tls = __webpack_require__(49);
const Timers = __webpack_require__(20);
const EventEmitter = __webpack_require__(9).EventEmitter;
...
const Packets = __webpack_require__(2);
const Commands = __webpack_require__(93);
  ...
  _resolveNamedPlaceholders(options) {
    ...
    if (this.config.namedPlaceholders || options.namedPlaceholders) {
      ...
      if (convertNamedPlaceholders === null) {
        convertNamedPlaceholders = __webpack_require__(116)();
      }
...
const Iconv = __webpack_require__(53);
...
const { URL } = __webpack_require__(114);
...
class ConnectionConfig {
  ...
  static getSSLProfile(name) {
    if (!SSLProfiles) {
      SSLProfiles = __webpack_require__(115);
    }
...
exports.createServer = function(handler) {
  const Server = __webpack_require__(121);
  const s = new Server();
  if (handler) {
...
const Yallist = __webpack_require__(50)
...
const Command = __webpack_require__(3);
const Packets = __webpack_require__(2);
const ClientConstants = __webpack_require__(10);
const CharsetToEncoding = __webpack_require__(5);
...
class ClientHandshake extends Command {
  ...
  handshakeResult(packet, connection) {
    ...
    if (marker === 0xfe || marker === 1) {
      const authSwitch = __webpack_require__(94);
      try {
        if (marker === 1) {
    ...
    if (!connection.authorized) {
      ...
      if (connection.config.compress) {
        const enableCompression = __webpack_require__(98)
          .enableCompression;
...
const Command = __webpack_require__(3);
const Packets = __webpack_require__(2);
const getTextParser = __webpack_require__(103);
...
var isProperty = __webpack_require__(104)
...
const getBinaryParser = __webpack_require__(106);
...
(function (factory) {
    if ( true && typeof module.exports === "object") {
        var v = factory(__webpack_require__(122), exports);
...
try {
  ...
  __webpack_require__(51)(Yallist)
} catch (er) {}
...
iconv.enableStreamingAPI = function enableStreamingAPI(stream_module) {
    ...
    var streams = __webpack_require__(71)(stream_module);
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(35).concat(__webpack_require__(70)) },
        encodeSkipVals: [
...
const CursorType = __webpack_require__(81);
const CommandCodes = __webpack_require__(4);
const Types = __webpack_require__(12);
const Packet = __webpack_require__(0);
const CharsetToEncoding = __webpack_require__(5);
...
const EncodingToCharset = __webpack_require__(89);
const sessionInfoTypes = __webpack_require__(90);
...
const ServerHandshake = __webpack_require__(102);
const Query = __webpack_require__(38);
const Prepare = __webpack_require__(105);
const CloseStatement = __webpack_require__(41);
const Execute = __webpack_require__(42);
const Ping = __webpack_require__(108);
const RegisterSlave = __webpack_require__(109);
const BinlogDump = __webpack_require__(110);
const ChangeUser = __webpack_require__(112);
const Quit = __webpack_require__(113);
...
const Packets = __webpack_require__(2);
const sha256_password = __webpack_require__(95);
const caching_sha2_password = __webpack_require__(96);
const mysql_native_password = __webpack_require__(97);
...
const zlib = __webpack_require__(99);
const PacketParser = __webpack_require__(31);
...
function enableCompression(connection) {
  ...
  const seqqueue = __webpack_require__(100);
...
const FieldFlags = __webpack_require__(107);
const Charsets = __webpack_require__(17);
const Types = __webpack_require__(12);
const helpers = __webpack_require__(39);
const genFunc = __webpack_require__(40);
...
class QueryEvent {
  constructor(packet) {
    const parseStatusVars = __webpack_require__(111);
...
function createCompiler(config) {
  ...
  if (config.cache !== false && !cache) {
    cache = __webpack_require__(117)({ max: ncache, dispose: EMPTY_LRU_FN });
  }
...
// A linked list to keep track of recently-used-ness
var Yallist = __webpack_require__(120)
...
var connection_string_parser = __webpack_require__(47);
...
const createConnection = () => {
    if (connectionString.includes('database=')) {
        const options = parseSemiColons(connectionString);
        ...
        return Object(promise["createPool"])(Object.assign(Object.assign({ host: options.hosts[0].host || 'localhost', port: options.hosts[0].port || 3306, user: options.username || 'root', password: options.password || '', database: options.endpoint, charset: 'utf8mb4_unicode_ci', connectTimeout: 30000 }, options.options), { namedPlaceholders: true }));
    }
};
...
const executeSync = (query, parameters, resource) => Object(tslib["__awaiter"])(void 0, void 0, void 0, function* () {
    if (!external_alt_server_["hasResource"](resource)) {
        throw new Error(`Invoked by invalid resource`);
    }
    const result = yield executeQuery(query, parameters, resource);
...
// function insertSync (query: string, parameters: unknown, resource: string): any {
...
//         throw new Error(`Incorrect query type, insert only do INSERT queries`);
//     }
//     const result = executeQuery(query, parameters, resource).then((res) => {
//         return 'melao'
//     })
// }
/* harmony default export */ var src = __webpack_exports__["default"] = ({ execute, insert, update, scalar, executeSync });
