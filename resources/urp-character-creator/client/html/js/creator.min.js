...
$('body').on('click', '.changeGender', function (event) {
    if(charDataGender != $(this).attr("data-value")) {
        ...
        alt.emit('Creator:charSetGender', parseInt(charDataGender))
...
function setter(event, setting, send_value) {
    ...
    if(event == 'parents') {
        ...
        alt.emit(`Creator:setHeadBlendData`, JSON.stringify(array))
    } else if(event == 'face') {
        ...
        alt.emit(`Creator:setFaceFeature`, JSON.stringify(array))
    } else if(event == 'eyes') {
        $("#eyeColorName").text(eyeColorNames[parseFloat(send_value)]);

        alt.emit(`Creator:setEyeColor`, parseFloat(send_value))
        ...
        alt.emit(`Creator:setHeadOverlay`, JSON.stringify(array))
        ...
        alt.emit(`Creator:setHeadOverlayColor`, JSON.stringify(array))
        ...
        alt.emit('Creator:setHair', charDataHair)
    } else if(event == 'hairColor') {
        charDataHairColor = parseInt(send_value);

        alt.emit('Creator:setHairColor', charDataHairColor)
    } else if(event == 'hairColorHighlight') {
        charDataHairColorHighlight = parseInt(send_value);

        alt.emit('Creator:setHairHighlightColor', charDataHairColorHighlight)
    }
}