    ...
    (b.prototype = {
        ...
        _setOptions: function () {
            ...
            for (a in this.options)
                (this.options[a] =
                    this.$el.attr('data-' + a) || this.options[a]),
        ...
        _scratchFunc: function (a, b) {
            (a.pageX = Math.floor(a.pageX - this.canvasOffset.left)),
                ...
                (this.options.realtime || 'Up' === b) &&
                    ...
                    this.options['scratch' + b].apply(this, [
                        a,
        ...
        (a.fn.wScratchPad = function (c, d) {
            ...
            if ('string' == typeof c) {
                ...
                return (
                    this.each(k), g.length ? (1 === g.length ? g[0] : g) : this
                );
            }
            return (
                (c = a.extend({}, a.fn.wScratchPad.defaults, c)), this.each(e)
            );
        }),
