...
(function (n) {
    var o = '0.4.2',
        ...
        t = function (n, f) {
            ...
            for (l.sort(c); l[a] < 0; )
                if (((e = y[l[a++]]), h.push(e.apply(f, v)), i))
                    return (i = w), h;
            for (o = 0; o < p; o++)
    ...
    t.listeners = function (n) {
        for (
            ...
            for (h = [], e = 0, p = c.length; e < p; e++)
                for (t = c[e].n, v = [t[a[r]], t[s]], o = 2; o--; )
                    (i = v[o]), i && (h.push(i), (l = l.concat(i.f || [])));
            c = h;
        }
        return l;
    };
    t.on = function (n, t) {
        ...
        for (e = n.split(f), i = u, r = 0, o = e.length; r < o; r++)
            (i = i.n),
                (i =
                    (i.hasOwnProperty(e[r]) && i[e[r]]) ||
                    (i[e[r]] = { n: {} }));
        for (i.f = i.f || [], r = 0, o = i.f.length; r < o; r++)
            if (i.f[r] == t) return h;
        return (
            i.f.push(t),
            function (n) {
    ...
    t.f = function (n) {
        ...
        return function () {
            t.apply(
                null,
                [n, null].concat(i).concat([].slice.call(arguments, 0))
            );
        };
    };
    t.stop = function () {
    ...
    (function (n, t) {
        ...
        function di(n, t, r) {
            ...
            for (u = 0; u < p + 1; u++)
                (h = i.findDotsAtSegment.apply(i, n.concat(u / p))),
                    nt.push({ x: h.x, y: h.y, t: u / p });
            for (u = 0; u < w + 1; u++)
                (h = i.findDotsAtSegment.apply(i, t.concat(u / w))),
                    tt.push({ x: h.x, y: h.y, t: u / w });
            for (u = 0; u < p; u++)
                for (c = 0; c < w; c++) {
                    var e = nt[u],
                        a = nt[u + 1],
                    ...
                    if (f) {
                        ...
                        d =
                            e.t +
                            y((f[b] - e[b]) / (a[b] - e[b])) * (a.t - e.t);
                        g =
                            s.t +
                            y((f[k] - s[k]) / (v[k] - s[k])) * (v.t - s.t);
                        d >= 0 &&
                            d <= 1.001 &&
                            g >= 0 &&
                            g <= 1.001 &&
        ...
        function kt(n, r, u, e, o, c) {
            ...
            if (it) {
                if (ot)
                    (ot.initstatus = e), (ot.start = new Date() - ot.ms * e);
                else {
                    for (l in it)
                        if (
                            it[a](l) &&
                            (wi[a](l) || r.paper.customAttributes[a](l))
                        ) {
                            y[l] = r.attr(l);
                            y[l] == null && (y[l] = bu[l]);
                            g[l] = it[l];
        ...
        var ai,
            ...
            dt =
                ...
                (r.win.DocumentTouch && r.doc instanceof DocumentTouch),
            d = '',
            lt = ' ',
            b = String,
            ut = 'split',
        ...
        if (
            ...
            (i.type =
                r.win.SVGAngle ||
                r.doc.implementation.hasFeature(
        ...
        i.getRGB = it(function (n) {
            ...
            if (n == 'none')
                return { r: -1, g: -1, b: -1, hex: 'none', toString: oi };
            ku[a](n.toLowerCase().substring(0, 2)) ||
                n.charAt() == '#' ||
                (n = ei(n));
            var u,
                f,
            ...
            return r
                ? (r[2] &&
                      ((e = st(r[2].substring(5), 16)),
                      (f = st(r[2].substring(3, 5), 16)),
                      (u = st(r[2].substring(1, 3), 16))),
                  r[3] &&
                      ((e = st((s = r[3].charAt(3)) + s, 16)),
                      (f = st((s = r[3].charAt(2)) + s, 16)),
                      (u = st((s = r[3].charAt(1)) + s, 16))),
                  r[4] &&
                      ((t = r[4][ut](bi)),
                      (u = h(t[0])),
                      t[0].slice(-1) == '%' && (u *= 2.55),
        ...
        i.rgb = it(function (n, t, i) {
            return (
                '#' +
                (16777216 | i | (t << 8) | (n << 16)).toString(16).slice(1)
            );
        });
            ...
            return (
                ...
                setTimeout(function () {
                    for (var i in t)
                        t[a](i) &&
                            i != n &&
                            (t[i].sleep--, t[i].sleep || delete t[i]);
                }),
                t[n]
            );
        };
        ...
        i.isBBoxIntersect = function (n, t) {
            ...
            return (
                ...
                r(n, t.x, t.y2) ||
                r(n, t.x2, t.y2) ||
                (((n.x < t.x2 && n.x > t.x) || (t.x < n.x2 && t.x > n.x)) &&
                    ((n.y < t.y2 && n.y > t.y) || (t.y < n.y2 && t.y > n.y)))
            );
        };
        ...
        var nr = (i.pathBBox = function (n) {
            ...
            af = (i._pathToRelative = function (n) {
                ...
                (i.is(n, tt) && i.is(n && n[0], tt)) ||
                    (n = i.parsePathString(n));
                var r = [],
                    o = 0,
                    e = 0,
                    l = 0,
                    ...
                    if (((f = r[u] = []), (t = n[u]), t[0] != ni.call(t[0]))) {
                        ...
                        switch (f[0]) {
                            ...
                            case 'm':
                                ...
                                a = t[2];
                            default:
                                for (s = 1, w = t.length; s < w; s++)
                                    f[s] = +(t[s] - (s % 2 ? o : e)).toFixed(3);
                        }
                    } else
                        for (
                            f = r[u] = [],
                                t[0] == 'm' && ((l = t[1] + o), (a = t[2] + e)),
                                h = 0,
                                b = t.length;
                            h < b;
                            h++
            ...
            tu = it(function (n, t, i, r, f, e, s, h) {
                ...
                return (
                    ...
                    p > 0 &&
                        p < 1 &&
                        ((a = hi(n, t, i, r, f, e, s, h, p)),
                        d.push(a.x),
                        k.push(a.y)),
                    w > 0 &&
                        w < 1 &&
                        ((a = hi(n, t, i, r, f, e, s, h, w)),
                        d.push(a.x),
                        k.push(a.y)),
                    (b = e - 2 * r + t - (h - 2 * e + r)),
                    (c = 2 * (r - t) - 2 * (e - r)),
                ...
                function (n, t) {
                    ...
                    var u = dr(n),
                        ...
                        k = function (n, t) {
                            if (n[t].length > 7) {
                                n[t].shift();
                                for (var r = n[t]; r.length; )
                                    n.splice(t++, 0, ['C'][s](r.splice(0, 6)));
                                n.splice(t, 1);
            ...
            fe = (i._parseDots = it(function (n) {
                for (
                    var f, s, c, e, u, l, r = [], t = 0, o = n.length;
                    t < o;
                    t++
                ) {
                    if (
                                ...
                                : o == 5 &&
                                  (k
                                      ? ((h = s.x(r[3], r[4])),
                                        (c = s.y(r[3], r[4])),
                                        u.scale(r[1], r[2], h, c))
                                      : u.scale(r[1], r[2], r[3], r[4]),
                                  (y *= r[1]),
                                  (p *= r[2]))
                            : l == 'm' &&
                              o == 7 &&
                              u.add(r[1], r[2], r[3], r[4], r[5], r[6]);
                        e.dirtyT = 1;
                        n.matrix = u;
                    }
                n.matrix = u;
            ...
            yf = (i._equaliseTransform = function (n, t) {
                ...
                for (
                    ...
                    if (
                        ...
                        return;
                    for (
                        s[u] = [], h[u] = [], f = 0, c = o(r.length, e.length);
                        f < c;
                        f++
                    )
                        f in r && (s[u][f] = r[f]), f in e && (h[u][f] = e[f]);
                }
                return { from: s, to: h };
            });
        i._getContainer = function (n, t, u, f) {
            ...
            if (
                ((e =
                    f == null && !i.is(n, 'object')
                        ? r.doc.getElementById(n)
                        : n),
                e != null)
            )
                return e.tagName
            ...
            (function (n) {
                ...
                n.split = function () {
                    ...
                    return (
                        ...
                        (o = f[1][1]),
                        o < 0
                            ? ((n.rotate = i.deg(u.acos(o))),
                              e < 0 && (n.rotate = 360 - n.rotate))
                            : (n.rotate = i.deg(u.asin(e))),
                        (n.isSimple =
                            !+n.shear.toFixed(9) &&
                            (n.scalex.toFixed(9) == n.scaley.toFixed(9) ||
                                !n.rotate)),
                        (n.isSuperSimple =
                            !+n.shear.toFixed(9) &&
                            n.scalex.toFixed(9) == n.scaley.toFixed(9) &&
        ...
        var pf = function () {
            ...
            uu = function (n) {
                var t = r.doc.documentElement.scrollTop || r.doc.body.scrollTop,
                    i =
                        r.doc.documentElement.scrollLeft ||
                ...
                return r.doc.addEventListener
                    ? function (n, t, i, r) {
                          ...
                          return (
                              ...
                              function () {
                                  return (
                                      n.removeEventListener(t, u, !1),
                                      dt &&
                                          gt[t] &&
                                          n.removeEventListener(gt[t], u, !1),
                                      !0
                                  );
                              }
                          );
                    ...
                    ? function (n, t, i, u) {
                          var f = function (n) {
                              n = n || r.win.event;
                              var t =
                                      r.doc.documentElement.scrollTop ||
                                  ...
                                  o = n.clientY + t;
                              return (
                                  (n.preventDefault = n.preventDefault || pf),
                                  (n.stopPropagation = n.stopPropagation || bf),
                                  i.call(u, n, e, o)
                              );
                          };
                          return (
            ...
            tr = function (n) {
                for (
                    ...
                    u.style.display = p;
                    r.win.opera &&
                        (a ? c.insertBefore(u, a) : c.appendChild(u));
                    h && t('raphael.drag.over.' + i.el.id, i.el, h);
                    f += y;
                    e += v;
                    t(
                        'raphael.drag.move.' + i.el.id,
                        i.move_scope || i.el,
                        f - i.el._drag.x,
                        e - i.el._drag.y,
                        f,
        ...
        e.data = function (n, r) {
            ...
            return (
                (u[n] = r), t('raphael.data.set.' + this.id, this, r, n), this
            );
        };
        e.removeData = function (n) {
            return (
                n == null
                    ? (at[this.id] = {})
                    : at[this.id] && delete at[this.id][n],
                this
            );
        };
        e.getData = function () {
        ...
        e.onDragOver = function (n) {
            n
                ? t.on('raphael.drag.over.' + this.id, n)
                : t.unbind('raphael.drag.over.' + this.id);
        };
        e.undrag = function () {
            for (var n = ct.length; n--; )
                ct[n].el == this &&
                    (this.unmousedown(ct[n].start),
                    ct.splice(n, 1),
        ...
        fu = function (n) {
            var u = n.getBoundingClientRect(),
                ...
                s =
                    u.top +
                    (r.win.pageYOffset || i.scrollTop || t.scrollTop) -
                    e,
                h =
                    u.left +
                    (r.win.pageXOffset || i.scrollLeft || t.scrollLeft) -
                    o;
            return { y: s, x: h };
        };
        ...
        e.isPointInside = function (n, t) {
            ...
            return (
                this.attr('transform') &&
                    ...
                    (r = i.transformPath(r, this.attr('transform'))),
        ...
        e.getBBox = function (n) {
            ...
            return n
                ? ((t.dirty || !t.bboxwt) &&
                      ((this.realPath = ri[this.type](this)),
                      (t.bboxwt = nr(this.realPath)),
                      (t.bboxwt.toString = eu),
                      (t.dirty = 0)),
                  t.bboxwt)
                : ((t.dirty || t.dirtyT || !t.bbox) &&
                      ((t.dirty || !this.realPath) &&
                          ((t.bboxwt = 0),
                          (this.realPath = ri[this.type](this))),
        ...
        e.glow = function (n) {
            ...
            for (
                i = this.matrix ? ki(i, this.matrix) : i, r = 1;
                r < u + 1;
                r++
            )
                e.push(
        ...
        g = i.easing_formulas = {
            ...
            elastic: function (n) {
                return n == !!n
                    ? n
                    : nt(2, -10 * n) * u.sin(((n - 0.075) * 2 * k) / 0.3) + 1;
            },
            bounce: function (n) {
                var r = 7.5625,
                    t = 2.75,
        ...
        var f = [],
            ...
            or = function () {
                for (
                    var ft = +new Date(), b = 0, n, v, r, u, g, c, nt, w, ut;
                    b < f.length;
                    b++
                )
                            ...
                            if (k < h) {
                                ...
                                if (
                                    ((function (n, r, u) {
                                        setTimeout(function () {
                                            t(
                                                'raphael.anim.frame.' + r.id,
                                                r,
                                                u
                                            );
                                            t(
                                                'raphael.anim.finish.' + r.id,
                                                r,
                                                u
                                            );
        ...
        e.animateWith = function (n, t, r, u, e, o) {
            ...
            for (
                c = r instanceof ft ? r : i.animation(r, u, e, o),
                    kt(c, s, c.percents[0], null, s.attr()),
                    h = 0,
                    l = f.length;
                h < l;
                h++
        ...
        e.onAnimation = function (n) {
            return (
                n
                    ? t.on('raphael.anim.frame.' + this.id, n)
        ...
        e.animate = function (n, t, r, u) {
            ...
            return f.removed
                ? (u && u.call(f), f)
                : ((e = n instanceof ft ? n : i.animation(n, t, r, u)),
                  kt(e, f, e.percents[0], null, f.attr()),
                  f);
        };
        ...
        e.pause = function (n) {
            for (var i = 0; i < f.length; i++)
                f[i].el.id != this.id ||
                    (n && f[i].anim != n) ||
                    (t('raphael.anim.pause.' + this.id, this, f[i].anim) !==
                        !1 &&
                        (f[i].paused = !0));
            return this;
        };
        ...
        e.stop = function (n) {
            for (var i = 0; i < f.length; i++)
                f[i].el.id != this.id ||
                    (n && f[i].anim != n) ||
                    (t('raphael.anim.stop.' + this.id, this, f[i].anim) !==
                        !1 &&
                        f.splice(i--, 1));
            return this;
        };
        ...
        w.attr = function (n, t) {
            ...
            if (n && i.is(n, tt) && i.is(n[0], 'object'))
                ...
                for (u = 0, e = this.items.length; u < e; u++)
        ...
        w.splice = function (n, t) {
            ...
            for (r = f.length, i = 0; i < r + u.length; i++)
        ...
        w.animate = function (n, t, r, u) {
            ...
            for (
                ...
                this.items[f] &&
                    ...
                    this.items[f].animateWith(h, o, o),
        ...
        w.getBBox = function () {
            for (
                var n, t = [], i = [], r = [], u = [], f = this.items.length;
                f--;

            )
                this.items[f].removed ||
                    ((n = this.items[f].getBBox()),
                    t.push(n.x),
                    i.push(n.y),
                    r.push(n.x + n.width),
                    u.push(n.y + n.height));
            return (
                ...
                (r = o[v](0, r)),
                (u = o[v](0, u)),
                { x: t, y: i, x2: r, y2: u, width: r - t, height: u - i }
            );
        };
        w.clone = function (n) {
            n = this.paper.set();
        ...
        i.registerFont = function (n) {
            ...
            if (
                (this.fonts[u] ? this.fonts[u].push(i) : (this.fonts[u] = [i]),
                !n.svg)
            ) {
            ...
            if (
                ...
                if (f)
                    for (s = 0, c = f.length; s < c; s++)
                        if (
                            ((e = f[s]),
                            e.face['font-weight'] == t &&
                                (e.face['font-style'] == r ||
                                    !e.face['font-style']) &&
                                e.face['font-stretch'] == u)
                        )
                            break;
                return e;
            }
        ...
        c.print = function (n, t, r, u, f, e, s, h) {
            ...
            if ((i.is(u, 'string') && (u = this.getFont(u)), u)) {
                ...
                var w = u.face.bbox[ut](vi),
                    ...
                    ft =
                        +w[1] +
                        (e == 'baseline' ? nt + +u.face.descent : nt / 2);
                ...
                if (i.svg) {
                    ...
                    var n = function (r, f) {
                            ...
                            if (f) {
                                ...
                                (r = i._g.doc.createElementNS(
                                    'http://www.w3.org/2000/svg',
                                    r
                                )),
                                    r.style &&
                                        (r.style.webkitTapHighlightColor =
                                            'rgba(0,0,0,0)');
                            return r;
                        },
                        it = function (t, r) {
                            ...
                            if (!a) {
                                ...
                                if (
                                    ...
                                    t.gradient &&
                                        l != t.gradient.id &&
                                        (it.defs.removeChild(t.gradient),
                                        delete t.gradient),
                                    !t.gradient)
                                )
                                    for (
                            ...
                            if (r.type == 'path') {
                                ...
                                a == 'open'
                                    ? ((v += 2),
                                      ...
                                      (ot = 1),
                                      (st = s ? 4 : 1),
                                      (c = { fill: 'none', stroke: l.stroke }))
                                    : ((st = ot = v / 2),
                                      (c = { fill: l.stroke, stroke: 'none' }));
                                r._.arrows
                                    ? s
                                        ? (r._.arrows.endPath &&
                                              e[r._.arrows.endPath]--,
                                          r._.arrows.endMarker &&
                                              e[r._.arrows.endMarker]--)
                                        : (r._.arrows.startPath &&
                                              e[r._.arrows.startPath]--,
                                          r._.arrows.startMarker &&
                                              e[r._.arrows.startMarker]--)
                                    : (r._.arrows = {});
                                a != 'none'
                                    ? ((b = 'raphael-marker-' + a),
                                      ...
                                      (it =
                                          ot * (a != 'diamond' && a != 'oval')),
                                      s
                                          ? ((p = r._.arrows.startdx * d || 0),
                                            (w =
                                                i.getTotalLength(l.path) -
                                                it * d))
                                          : ((p = it * d),
                                            (w =
                                                i.getTotalLength(l.path) -
                                                (r._.arrows.enddx * d || 0))),
                                      (c = {}),
                                      (c['marker-' + h] = 'url(#' + k + ')'),
                                      (w || p) &&
                                          (c.d = i.getSubpath(l.path, p, w)),
                                      n(ct, c),
                                      (r._.arrows[h + 'Path'] = b),
                                ...
                                if (f[t](v)) {
                                    ...
                                    switch (v) {
                                        ...
                                        case 'stroke-width':
                                            ...
                                            h.setAttribute(v, e);
                                            c['stroke-dasharray'] &&
                                                rt(r, c['stroke-dasharray'], f);
                                            r._.arrows &&
                                                ('startString' in r._.arrows &&
                                                    s(
                                                        r,
                                                        r._.arrows.startString
                                                    ),
                                                'endString' in r._.arrows &&
                                                    s(
                                                        r,
                                                        r._.arrows.endString,
                                                        1
                                                    ));
                                            break;
                                ...
                                if (f[t]('text')) {
                                    ...
                                    for (
                                        ...
                                        (l = n('tspan')),
                                            e && n(l, { dy: w * ut, x: c.x }),
                                            l.appendChild(
                                                i._g.doc.createTextNode(y[e])
                                            ),
                                            s.appendChild(l),
                                            (h[e] = l);
                                } else
                                    for (
                                        h = s.getElementsByTagName('tspan'),
                                            e = 0,
                                            a = h.length;
                                        e < a;
                                        e++
                    ...
                    i._engine.path = function (t, i) {
                        var u = n('path'),
                            r;
                        return (
                            i.canvas && i.canvas.appendChild(u),
                            (r = new h(u, i)),
                            (r.type = 'path'),
                            g(r, { fill: 'none', stroke: '#000', path: t }),
                            r
                        );
                    };
                    r.rotate = function (n, t, i) {
                        ...
                        return (
                            this.transform(
                                this._.transform.concat([['r', n, t, i]])
                            ),
                            this
                        );
                    };
                    r.scale = function (n, t, i, r) {
                        ...
                        return (
                            ...
                            this.transform(
                                this._.transform.concat([['s', n, t, i, r]])
                            ),
                            this
                        );
                    };
                    ...
                    r.transform = function (r) {
                        ...
                        return r == null
                            ...
                            : (i._extractTransform(this, r),
                              ...
                              this.pattern && b(this),
                              this.node &&
                                  n(this.node, { transform: this.matrix }),
                              (u.sx != 1 || u.sy != 1) &&
                                  ((f = this.attrs[t]('stroke-width')
                    ...
                    r.attr = function (n, r) {
                        ...
                        if (r == null && i.is(n, 'array')) {
                            for (s = {}, o = 0, h = n.length; o < h; o++)
                                s[n[o]] = this.attr(n[o]);
                            return s;
                        }
                        r != null
                            ? ((f = {}), (f[n] = r))
                            : n != null && i.is(n, 'object') && (f = n);
                        for (u in f)
                            p('raphael.attr.' + u + '.' + this.id, this, f[u]);
                        for (u in this.paper.customAttributes)
                            if (
                                this.paper.customAttributes[t](u) &&
                                f[t](u) &&
                                i.is(this.paper.customAttributes[u], 'function')
                            ) {
                                v = this.paper.customAttributes[u].apply(
                                    this,
                                    [].concat(f[u])
                                );
                                this.attrs[u] = f[u];
                        ...
                        return (
                            ...
                            t == 1
                                ? ((r.style.cssText =
                                  ...
                                  (c = 1))
                                : ((r.style.cssText = h + 'position:relative'),
                                  t.firstChild
                    ...
                    i._engine.setViewBox = function (t, i, r, u, f) {
                        p('raphael.setViewBox', this, this._viewBox, [
                            t,
                            i,
                            r,
                            u,
                        ...
                        for (
                            t == null
                                ? (this._vbSize && (o = 1),
                                  delete this._vbSize,
                                  (s = '0 0 ' + this.width + w + this.height))
                                : ((this._vbSize = o),
                                  (s = t + w + i + w + r + w + u)),
                                n(this.canvas, {
                                    viewBox: s,
                            ...
                            (h =
                                'stroke-width' in e.attrs
                                    ? e.attrs['stroke-width']
                                    : 1),
                    ...
                    i.prototype.clear = function () {
                        ...
                        (this.desc = n('desc')).appendChild(
                            i._g.doc.createTextNode(
                                'Created with Raphaël ' + i.version
                            )
                        );
            ...
            (function () {
                ...
                if (i.vml) {
                    var h = 'hasOwnProperty',
                        ...
                        lt = function (r) {
                            var l = /[ahqstv]/gi,
                                ...
                                p;
                            if (
                                (t(r).match(l) && (a = i._path2curve),
                                (l = /[clmz]/g),
                                a == i._pathToAbsolute && !t(r).match(l))
                            )
                        ...
                        v = function (r, c) {
                            ...
                            if (
                                ...
                                ((c.path && r.type == 'path') || ui) &&
                                    ((b.path = lt(
                                        ~t(v.path).toLowerCase().indexOf('r')
                                            ? i._pathToAbsolute(v.path)
                                            : v.path
                                    )),
                                    r.type == 'image' &&
                                        ((r._.fillpos = [v.x, v.y]),
                                        (r._.fillsize = [v.width, v.height]),
                                        w(r, 1, 1, 0, 0, 0))),
                            ...
                            if (
                                ...
                                r.textpath &&
                                    ...
                                    c['font-family'] &&
                                        (ft.fontFamily =
                                            ...
                                            '"'),
                                    c['font-size'] &&
                                        (ft.fontSize = c['font-size']),
                                    c['font-weight'] &&
                                        (ft.fontWeight = c['font-weight']),
                                    c['font-style'] &&
                                        (ft.fontStyle = c['font-style'])),
                                ...
                                (c.opacity != null ||
                                    ...
                                    b.appendChild(y),
                                    (d =
                                        b.getElementsByTagName('stroke') &&
                                        b.getElementsByTagName('stroke')[0]),
                                    (dt = !1),
                                    d || (dt = d = s('stroke')),
                                    ...
                                    (d.miterlimit =
                                        c['stroke-miterlimit'] || 8),
                                    c['stroke-linecap'] &&
                                        (d.endcap =
                                            c['stroke-linecap'] == 'butt'
                                                ? 'flat'
                                                : c['stroke-linecap'] ==
                                                  'square'
                                                ? 'square'
                                ...
                                for (
                                    it = ti.style,
                                        ...
                                        v['font-family'] &&
                                            (it.fontFamily = v['font-family']),
                                        v['font-weight'] &&
                                            (it.fontWeight = v['font-weight']),
                                        v['font-style'] &&
                                            (it.fontStyle = v['font-style']),
                                        wt =
                                            f(
                                                v['font-size'] || (wt && wt[0])
                                            ) || 10,
                                        ...
                                        p.textpath.string &&
                                            (ti.innerHTML = t(p.textpath.string)
                                                .replace(/</g, '&#60;')
                                                .replace(/&/g, '&#38;')
                                                .replace(/\n/g, '<br>')),
                        ...
                        at = function (n, r, e) {
                            ...
                            if (((n = n.shape || n.node), s.length)) {
                                for (
                                    ...
                                    s[h].offset &&
                                        a.push(s[h].offset + o + s[h].color);
                                e.colors = a.length
                                    ? a.join()
                                    : '0% ' + e.color;
                                y == 'radial'
                                    ? ((e.type = 'gradientTitle'),
                                      (e.focus = '100%'),
                                      (e.focussize = '0 0'),
                                      (e.focusposition = p),
                                      (e.angle = 0))
                    ...
                    r.transform = function (r) {
                        ...
                        a = e
                            ? 's' + [e.scale, e.scale] + '-1-1t' + [e.dx, e.dy]
                            : u;
                        e &&
                            (l = r =
                                t(r).replace(
                    ...
                    r.rotate = function (n, i, r) {
                        ...
                        if (n != null) {
                            ...
                            return (
                                (this._.dirtyT = 1),
                                this.transform(
                                    this._.transform.concat([['r', n, i, r]])
                                ),
                                this
                            );
                        }
                    ...
                    r.translate = function (n, i) {
                        return this.removed
                            ...
                            : ((n = t(n).split(a)),
                              ...
                              (i = +i || 0),
                              this._.bbox &&
                                  ((this._.bbox.x += n), (this._.bbox.y += i)),
                              this.transform(
                                  this._.transform.concat([['t', n, i]])
                              ),
                              this);
                    };
                    r.scale = function (n, i, r, u) {
                        ...
                        return (
                            ...
                            this.transform(
                                this._.transform.concat([['s', n, i, r, u]])
                            ),
                            (this._.dirtyT = 1),
                            this
                        );
                    ...
                    r.show = function () {
                        return (
                            this.removed || (this.node.style.display = u), this
                        );
                    };
                    r._getBBox = function () {
                        return this.removed
                    ...
                    r.attr = function (n, t) {
                        ...
                        if (r) {
                            for (u in this.paper.customAttributes)
                                if (
                                    this.paper.customAttributes[h](u) &&
                                    r[h](u) &&
                                    i.is(
                                        this.paper.customAttributes[u],
                                        'function'
                                    )
                                ) {
                                    p = this.paper.customAttributes[u].apply(
                                        this,
                                        [].concat(r[u])
                                    );
                                    this.attrs[u] = r[u];
                    ...
                    r.insertAfter = function (n) {
                        return this.removed
                            ? this
                            : (n.constructor == i.st.constructor &&
                                  (n = n[n.length - 1]),
                              n.node.nextSibling
                    ...
                    i._engine.setSize = function (n, t) {
                        ...
                        return (
                            ...
                            (r.clip = 'rect(0 ' + n + ' ' + t + ' 0)'),
                            this._viewBox &&
                                i._engine.setViewBox.apply(this, this._viewBox),
                            this
                        );
                    };
                    i._engine.setViewBox = function (n, t, r, u, f) {
                        i.eve('raphael.setViewBox', this, this._viewBox, [
                            n,
                            t,
                            r,
                            u,
