...
alt.everyTick(() => {
    ...
    if(isOpen) {
        ...
        drawText2D('/noclip', { x: 0.8, y: 0.075 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/cloth, [component, drawable, texture]', { x: 0.8, y: 0.1 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/addmoney [moneytype, amount], moneytype = cash or bank', { x: 0.8, y: 0.125 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/toggleEngine', { x: 0.8, y: 0.15 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/showid', { x: 0.8, y: 0.175 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/showssn', { x: 0.8, y: 0.2 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
        drawText2D('/addItem [item, amount, slot]', { x: 0.8, y: 0.225 }, 0.35, { r: 255, g: 255, b: 255, a: 255 }, 1);
