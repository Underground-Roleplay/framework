export const Items = {
    ...
    id_card: {
        ...
        combinable: 'nil',
        description:
            'A card containing all your information to identify yourself',
    },
    driver_license: {
        name: 'driver_license',
    ...
    lawyerpass: {
        ...
        combinable: 'nil',
        description:
            'Pass exclusive to lawyers to show they can represent a suspect',
    },
    weaponlicense: {
        name: 'weaponlicense',
    ...
    rolling_paper: {
        ...
        description:
            'Paper made specifically for encasing and smoking tobacco or cannabis.',
    },
    'weed_white-widow': {
    ...
    copper: {
        ...
        combinable: 'nil',
        description:
            'Nice piece of metal that you can probably use for something',
    },
    aluminum: {
        name: 'aluminum',
        label: 'Aluminium',
    ...
    iron: {
        ...
        combinable: 'nil',
        description:
            'Handy piece of metal that you can probably use for something',
    },
    ironoxide: {
        name: 'ironoxide',
        label: 'Iron Powder',
    ...
    rubber: {
        ...
        combinable: 'nil',
        description:
            'Rubber, I believe you can make your own rubber ducky with it :D',
    },
    glass: {
        name: 'glass',
        label: 'Glass',
    ...
    lockpick: {
        ...
        description:
            'Very useful if you lose your keys a lot.. or if you want to use it for something else...',
    },
    advancedlockpick: {
        ...
        combinable: 'nil',
        description:
            'If you lose your keys a lot this is very useful... Also useful to open your beers',
    },
    electronickit: {
        name: 'electronickit',
    ...
    cleaningkit: {
        ...
        combinable: 'nil',
        description:
            'A microfiber cloth with some soap will let your car sparkle again!',
    },
    tunerlaptop: {
        name: 'tunerlaptop',
        label: 'Tunerchip',
        ...
        combinable: 'nil',
        description:
            "With this tunerchip you can get your car on steroids... If you know what you\\'re doing",
    },
    harness: {
        name: 'harness',
        label: 'Race Harness',
    ...
    firstaid: {
        ...
        combinable: 'nil',
        description:
            'You can use this First Aid kit to get people back on their feet',
    },
    bandage: {
        name: 'bandage',
        label: 'Bandage',
    ...
    painkillers: {
        ...
        combinable: 'nil',
        description:
            "For pain you can\\'t stand anymore, take this pill that\\'d make you feel great again",
    },
    walkstick: {
        name: 'walkstick',
        label: 'Walking Stick',
    ...
    radioscanner: {
        ...
        combinable: 'nil',
        description:
            'With this you can get some police alerts. Not 100% effective however',
    },
    pinger: {
        name: 'pinger',
        label: 'Pinger',
        ...
        combinable: 'nil',
        description:
            'With a pinger and your phone you can send out your location',
    },
    cryptostick: {
        name: 'cryptostick',
        label: 'Crypto Stick',
        ...
        combinable: 'nil',
        description:
            "Why would someone ever buy money that doesn\\'t exist.. How many would it contain..?",
    },
    rolex: {
        name: 'rolex',
        label: 'Golden Watch',
    ...
    handcuffs: {
        ...
        combinable: 'nil',
        description:
            'Comes in handy when people misbehave. Maybe it can be used for something else?',
    },
    police_stormram: {
    ...
    empty_evidence_bag: {
        ...
        combinable: 'nil',
        description:
            'Used a lot to keep DNA from blood, bullet shells and more',
    },
    filled_evidence_bag: {
